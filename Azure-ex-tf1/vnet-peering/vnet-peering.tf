# This file needs to be copied into the vnet-main for peering to be created post secure-vnet configuration
...
resource "azurerm_role_assignment" "vnet" {
  scope              = module.vnet-main.vnet-id
...
resource "azurerm_virtual_network_peering" "main" {
  name                      = "main_2_sec"
  resource_group_name       = var.resource_group_name  # rg group name to be given during terraform plan/apply
  virtual_network_name      = module.vnet.vname_name
